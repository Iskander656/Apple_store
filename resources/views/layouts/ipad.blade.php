    <div class="intro-section py-5 bg-black">
        <div class="container-xl">
            <h1 class="text-center display-6 text-white fw-bold">iPad Pro</h1>
            <h2 class="text-center mb-4 text-white fw-lighter">Unbelivably thin. Incredibly powerful.</h2>
