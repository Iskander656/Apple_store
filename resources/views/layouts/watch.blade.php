    <div class="intro-section py-5" style="background-color: #ffffff;">
        <div class="container-xl">
            <h1 class="text-center display-6 fw-semibold"><i class="bi-apple"></i>WATCH</h1>
            <h4 class="text-center" style="letter-spacing: 3px;">SERIES 10</h4>
