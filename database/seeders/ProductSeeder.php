...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                'name' => 'MagSafe Silicone Case for iPhone 14',
                'description' => 'Silicone exterior with soft microfiber lining, compatible with MagSafe',
                'price' => 49.00,
                'stock' => 51,
                'category' => 'Accessories',
                'image' => 'img/Magsafe-14.jpeg',
            ],
            [
                'name' => 'MagSafe Leather Case for iPhone 14 Pro',
                'description' => 'Made from specially tanned and finished European leather',
                'price' => 59.00,
                'stock' => 30,
                'category' => 'Accessories',
                'image' => 'img/Magsafe-14-pro.avif',
            ],
            [
                'name' => 'Polishing Cloth',
                'description' => 'Soft cloth designed to clean Apple products safely',
                'price' => 19.00,
                'stock' => 100,
                'category' => 'Accessories',
                'image' => 'img/Cloth.jpeg',
            ],
            [
                'name' => 'HomePod mini',
                'description' => 'Amazing sound, smart assistant, compact design',
                'price' => 99.00,
                'stock' => 20,
                'category' => 'Accessories',
                'image' => 'img/Homepod-mini.png',
            ],
            [
            ...
            [
                'name' => 'AirPods Max',
                'description' => 'High-fidelity audio, Active Noise Cancellation, Dynamic Drivers, Spatial audio support',
                'price' => 549.00,
                'stock' => 8,
                'category' => 'AirPods',
